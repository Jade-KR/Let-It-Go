# Generated by Django 3.0.6 on 2020-05-18 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.LegoPart')),
                ('set_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.LegoSet')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
